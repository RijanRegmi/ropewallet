        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
              ...
              {/* Technical Specifications Specs Bar (Transparent White Glass Boxes) */}
              <div className="pt-6 border-t border-white/25 grid grid-cols-2 sm:grid-cols-4 gap-4 text-left max-w-xl mx-auto lg:mx-0">
                <div className="bg-white/15 backdrop-blur-xl border border-white/25 p-3.5 rounded-2xl shadow-xl">
                  <div className="text-xs text-emerald-200 font-bold">Version</div>
                  <div className="text-sm font-black text-white mt-0.5">
                    v1.0.0 (Build 2)
                  </div>
                </div>
                <div className="bg-white/15 backdrop-blur-xl border border-white/25 p-3.5 rounded-2xl shadow-xl">
                  <div className="text-xs text-emerald-200 font-bold">File Size</div>
                  <div className="text-sm font-black text-white mt-0.5">
                    42.0 MB
                  </div>
                </div>
                <div className="bg-white/15 backdrop-blur-xl border border-white/25 p-3.5 rounded-2xl shadow-xl">
                  <div className="text-xs text-emerald-200 font-bold">Requirement</div>
                  <div className="text-sm font-black text-white mt-0.5">
                    Android 8.0+
                  </div>
                </div>
                <div className="bg-white/15 backdrop-blur-xl border border-white/25 p-3.5 rounded-2xl shadow-xl">
                  <div className="text-xs text-emerald-200 font-bold">Security</div>
            ...
            <div className="lg:col-span-5 relative flex justify-center items-center mt-10 lg:mt-0">
              <div className="relative animate-float">
                ...
                {/* Floating Badge 1 (Top Left - White Glass Box) */}
                <div className="absolute -left-6 top-8 bg-white/20 backdrop-blur-xl border border-white/30 px-4 py-2.5 rounded-2xl shadow-2xl z-20 hidden sm:flex items-center gap-2.5 text-xs font-black text-white">
                  <div className="w-7 h-7 rounded-xl bg-white text-emerald-950 flex items-center justify-center font-bold text-xs shadow-sm">
                    ⚡
                  </div>
                  <div>
                    <span className="block text-[9px] text-emerald-200 font-bold uppercase">Verification</span>
                    <span className="text-xs text-white font-black">Instant &lt;3s Settlement</span>
                  </div>
                </div>

                {/* Floating Badge 2 (Bottom Right - White Glass Box) */}
                <div className="absolute -right-6 bottom-10 bg-white/20 backdrop-blur-xl border border-white/30 px-4 py-2.5 rounded-2xl shadow-2xl z-20 hidden sm:flex items-center gap-2.5 text-xs font-black text-white">
                  <div className="w-7 h-7 rounded-xl bg-white text-teal-950 flex items-center justify-center font-bold text-xs shadow-sm">
                    🛡️
                  </div>
                  <div>
                    <span className="block text-[9px] text-emerald-200 font-bold uppercase">Security Split</span>
                    <span className="text-xs text-white font-black">80% Host / 20% Fee</span>
                  </div>
                </div>
          ...
          {/* How to Install Section (Transparent White Glass Box) */}
          <section className="mt-28 bg-white/15 backdrop-blur-2xl border border-white/25 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 text-xs font-black text-emerald-200 uppercase tracking-widest mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              {/* Step 1 */}
              <div className="bg-white/15 backdrop-blur-xl border border-white/25 p-6 rounded-2xl relative shadow-lg">
                <div className="w-10 h-10 rounded-xl bg-white text-emerald-950 flex items-center justify-center font-black text-lg mb-4 shadow-md">
                  1
                </div>
            ...
            {/* Play Protect Tip Note Banner (White Glass) */}
            <div className="mt-8 bg-white/20 backdrop-blur-xl border border-white/30 p-5 sm:p-6 rounded-2xl flex items-start gap-4 text-left shadow-lg">
              <div className="w-10 h-10 rounded-xl bg-white text-emerald-950 flex items-center justify-center shrink-0 shadow-md mt-0.5 font-bold">
                <ShieldCheck className="w-5 h-5 text-emerald-700" />
              </div>
              <div className="space-y-1">
                <h4 className="text-sm font-black text-white flex items-center gap-2">
                  <span>Google Play Protect Prompt?</span>
                  <span className="text-[10px] uppercase tracking-wider font-black px-2 py-0.5 bg-emerald-300 text-emerald-950 rounded-full">
                    Safe & Verified
                  </span>
                </h4>
          ...
          {/* Key App Features (4 Transparent White Glass Boxes) */}
          <section className="mt-28">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              <div className="bg-white/15 backdrop-blur-xl border border-white/25 p-6 rounded-2xl hover:bg-white/20 hover:border-white/40 hover:shadow-2xl hover:-translate-y-1 transition-all shadow-xl">
                <div className="w-12 h-12 rounded-xl bg-white/20 text-white flex items-center justify-center mb-4 border border-white/30 shadow-xs">
          ...
          {/* Footer Callout (Transparent White Glass Box) */}
          <div className="mt-28 bg-white/15 backdrop-blur-2xl border border-white/25 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden shadow-2xl text-white">
            <h2 className="text-3xl sm:text-4xl font-black text-white">
              Ready to experience modern digital banking?
            </h2>
            <p className="text-emerald-100 mt-2 max-w-xl mx-auto text-base font-medium">
            ...
            <div className="mt-8 flex justify-center">
              <a
                href="/ropewallet.apk"
                download="RopeWallet.apk"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-white text-emerald-950 hover:bg-slate-50 active:scale-95 font-black text-lg shadow-2xl shadow-emerald-950/40 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
              >
                <Download className="w-6 h-6 text-emerald-700" />
                <span className="text-emerald-950 font-bold">Download APK (42 MB)</span>
              </a>
            </div>
          </div>
        </div>
